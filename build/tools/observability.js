...
import { getAggregatedStats, getMetricsAsText } from '../utils/metrics.js';
export async function executeGetObservability(input = {}) {
    ...
    if (chartType === 'none') {
        const meta = {
            ...
            style: { suggested_theme: 'corporate', applied_theme: null },
